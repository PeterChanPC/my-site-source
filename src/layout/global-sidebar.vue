<template>
  <aside :class="[
    'fixed r--200 flex flex-col t-0 w-180 h-full pt-50 pr-10 pl-10 bg-glassy ts-1-0 z-99',
    { 'sm:r-0': toggled },
  ]">
  ...
  <!-- background -->
  <div :class="['bg-dark fixed t-0 l-0 w-dvw h-dvh o-0 z--0 ts-1-0', { 'sm:o-1 sm:z-98': toggled }]"
    @click="toggleSidebar()">
  </div>
</template>
