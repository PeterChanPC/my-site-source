<template>
  <Transition name="slide-from-right">
    <aside v-if="toggled && !loadingStore.isLoading"
      class="fixed r-0 flex flex-col t-0 w-180 h-full pt-50 pr-10 pl-10 bg-glassy ts-1-0 z-99">
  ...
  <Transition name="fade">
    <div v-if="toggled && !loadingStore.isLoading" class="bg-dark fixed t-0 l-0 w-dvw h-dvh z-98"
