<template>
  <div class="page flex a-center j-start" @click="hideIntro()">
    ...
    <div v-if="isStarted" class="grid grid-cols-2 pl-1/10 pr-1/10 z-1">
      <AnimatedTxt class="col-span-2 hem-10 pb-10 font-size-md lsem-0.1" :text="t('hello')" :duration="500"
        :stagger-in="50" />
      <AnimatedTxt class="sm:col-span-2 hem-10 font-size-4xl lsem-0.5 txt-shadow uppercase" text="peter"
        :duration="1000" :stagger-in="100" />
      <AnimatedTxt class="sm:col-span-2 hem-10 font-size-4xl lsem-0.5 txt-shadow uppercase" text="chan" :duration="1000"
        :delay="500" :stagger-in="100" />
    </div>
  </div>
</template>
