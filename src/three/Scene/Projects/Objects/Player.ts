...
export class Player implements MonoBehavior {
  ...
  private wallMaterial: THREE.MeshBasicMaterial = new THREE.MeshBasicMaterial({ color: 0x000000 });
  ...
  private applyMovement() {
    ...
    this.wall.position.set(this.mouseWorldPos.x, this.mouseWorldPos.y, 0);
  };
